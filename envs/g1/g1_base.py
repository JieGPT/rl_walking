"""Base class for G1 robot environments.

This module provides common functionality shared across G1 environment
implementations (walking, etc.).
"""
...
class G1BaseEnv(BaseHumanoidEnv):
    """Base class for G1 humanoid environments.

    Provides G1-specific common functionality:
    ...
    def _setup_robot(self) -> None:
        ...
        # Get neutral standing pose from config
        self.half_sitting_pose = self.cfg.half_sitting_pose

        # Define nominal pose
        base_position = [0, 0, 0.79]
    ...
    def _get_robot_state_len(self) -> int:
        ...
        # root_r(1) + root_p(1) + root_ang_vel(3) + motor_pos(12) + motor_vel(12) + motor_tau(12)
        return 41
